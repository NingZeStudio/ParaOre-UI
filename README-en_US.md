...
```html
<script type="module">
  import { CustomButton, CustomCheckbox, showModal, showPop } from '@ningze/paraore-ui/dist/js/index.js';
</script>
```
...
| Checkbox | `.custom-checkbox` (pure CSS) |
...
| Utils | `ifNavigating()`, `openLink()`, etc. |
